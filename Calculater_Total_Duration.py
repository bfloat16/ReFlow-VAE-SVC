...
def parallel_process(filelist, num_processes):
    results = []
    with ProcessPoolExecutor(max_workers=num_processes) as executor:
        tasks = [executor.submit(calculate_durations, filelist[rank::num_processes]) for rank in range(num_processes)]
        for future in tasks:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_dir", type=str, default=r"data/底模/train/audio")
